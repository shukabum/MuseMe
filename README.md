# 🎵 Mood-Based Playlist Chrome Extension  
...
6. **To make it work You need to "just" edit the background.js file to put in your own Spotify API key and aimlapi API keys** (you are smart enough to browse the code to edit)
